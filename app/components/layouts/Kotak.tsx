      ...
      <div className="mt-24">
        ...
        <section className="max-w-240 container">
          ...
          <div className="mt-4">
            ...
            <div className="mt-6">
              <Paragraph>
                We engaged in a collaborative effort with the Kotak Mutual Funds
                team to revamp the mutual funds advisor portal. Our primary
                objective was to craft visually captivating screens while
                simultaneously addressing any user experience challenges,
        ...
        <section className="mt-40 max-w-240 container">
          ...
          <div className="mt-4">
            ...
            <div className="mt-6">
              <List>
                <ListItem>
                  The mutual fund advisor portal was designed to assist users in
                  managing investor portfolios and monitoring progress in total
                  systematic investment plans (SIPs) and total assets under
                  management (AUM).
                </ListItem>
                <ListItem>
                  However, the portal falls short in delivering a smooth overall
                  experience due to complex navigation, unstructured information
                  hierarchy, and a dashboard that lacks prominent display of
          ...
          <div className="mt-4">
            ...
            <div className="mt-6 flex gap-12">
              <Paragraph>
                ...
                professionals are responsible for managing investor portfolios,
                monitoring their progress in total SIPs, and overseeing total
                assets under management (AUM). The portal is designed to enhance
                their efficiency and effectiveness in providing financial
                guidance and support to their clients.
              </Paragraph>
        ...
        <section className="bg-light py-32 mt-24">
          <div className="container max-w-240">
            <div>
              ...
              <div className="mt-4">
                <HeadingText>
                  Create a scalable product with appropriate nudges, digestible
                  data, and a minimal yet playful UI to enhance user engagement
                </HeadingText>
              </div>
            </div>
            <div className="mt-20 sm:mt-32">
              ...
              <div className="mt-4">
                <HeadingText>
                  As a part of a bigger portfolio of products that Kotak offers,
                  the redesign was constrained by brand language, existing
                  feature list, and standardised UI patterns across the
                  products.{" "}
                </HeadingText>
              </div>
            </div>
            ...
            <div className="mt-6">
              <List>
                ...
                <ListItem>
                  ...
                  portal&apos;s style and flow, and after further iterations and
                  feature additions to the design prototype, my team and I
          ...
          <div className="container max-w-240">
            ...
            <div className="mt-6">
              <List>
                ...
                <ListItem>
                  This benchmarking process helped identify industry standards,
                  gaps in existing solutions, and opportunities to create a more
                  intuitive, feature-rich platform that caters specifically to
                  the needs of mutual fund advisors.
                </ListItem>
              </List>
            </div>
            <div className="mt-6">
        ...
        {/* wireframes */}
        <section className="container max-w-240 mt-24">
          ...
          <div className="container max-w-240">
            ...
            <div className="mt-6">
              <Paragraph>
                ...
                between professionalism and visual appeal. This approach ensures
                a user-friendly experience that is both modern and aligned with
                the brand identity.
              </Paragraph>
            </div>
            <div className="mt-16">
          ...
          <div className="container max-w-240">
            ...
            <div className="mt-8 flex flex-col gap-8">
              <div className="flex gap-2 items-start">
                ...
                <div>
                  <span className="font-bold text-2xl">Get feedback early</span>
                  <p className="mt-1">
              ...
              <div className="flex gap-2">
                ...
                <div>
                  <span className="font-bold text-2xl">Go back to basics</span>
                  <p className="mt-1">
                    During the design process, we often place too much emphasis
                    on visuals and overlook the core user needs. My team and I
                    had to step back and refocus on presenting the data clearly,
                    rather than solely prioritizing visual appeal.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="mt-1">
                    ...
                    motivating both myself and my team to keep iterating for the
                    best results. This experience taught me how to effectively
