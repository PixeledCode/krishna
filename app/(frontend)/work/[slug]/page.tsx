    ...
    <main className="mt-12 mb-32">
      ...
      <div className="mt-24">
        ...
        <section className="mt-36 flex justify-center flex-col items-center">
          ...
          <button
            type="button"
            className="uppercase font-lato leading-tight py-5 px-8 rounded-full border-[2px] border-solid border-primary text-primary text-xl font-bold mt-6"
          >
        ...
        <section className="mt-32 container max-w-240">
          ...
          <div className="gap-5 grid auto-fill-[300px] mt-10">
